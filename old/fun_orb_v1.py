def orb_watching(frame, imgs0, xy_imgs0, delt_xy, edge_width, test_mode=0):
    ...
    for i_obj, img0 in enumerate(imgs0):
        ...
        return out_img_sample, out_coord, out_delt_xy, img_match_frame
...
while cap.isOpened():
    ...
    if isrtrn:
        ...
        # elif (count > 218) & (count < 226):
            ...
            # smpls, smpl_xy, delt_xy, img_match = orb_watching(fr_curr, smpls, smpl_xy, delt_xy, edge_w, test_mode=test_mode)
            out_img_smpl, out_xy, out_delt_xy, out_img_match = orb_watching(fr_curr, smpls, smpl_xy, delt_xy, edge_w, test_mode=test_mode)
            if out_delt_xy[0]: #there was found some matched objects in a current frame
                smpls, smpl_xy, delt_xy, img_match = out_img_smpl, out_xy, out_delt_xy, out_img_match
